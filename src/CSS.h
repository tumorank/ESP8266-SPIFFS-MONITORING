void append_page_header() {
  ...
  webpage += F("<head>");
  webpage += F("<title> Monitoring PV </title>"); // NOTE: 1em = 16px
  webpage += F("<meta name='viewport' content='user-scalable=yes,initial-scale=1.0,width=device-width'>");
  webpage += F("<style>");
  webpage += F("body{max-width:100%;margin:0 auto;font-family:arial;font-size:125%;text-align:center;color:blue;background-color:#F7F2Fd;}");
  ...
  webpage += F("li a{display: block;border-radius:0.375em;padding:0.375em 0.375em;text-decoration:none;font-size:85%}");
  webpage += F("li a:hover{background-color:#EAE3EA;border-radius:0.375em;font-size:85%}");
  webpage += F("section {font-size:0.88em;}");
  webpage += F("h1{color:white;border-radius:0.5em;font-size:1.0em;padding:0.5em 0.5em;background:#558ED5;}");
  webpage += F("h2{color:orange;font-size:1.0em;}");
  webpage += F("h3{font-size:0.8em;}");
  webpage += F("table{font-family:arial,sans-serif;font-size:0.7500em;border-collapse:collapse;width:100%;}"); 
